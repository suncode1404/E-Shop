...
@section('content')
    <div class="container mt-5">
        @if ($order->count() == 0)
            <img src="{{ asset('images/emty.png') }}" alt="" class="img-fluid">
        @endif
        @foreach ($order as $od)
            <div class="card">
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-around">
                                <a class="btn btn-primary text-light @if ($od->status_id == 5) d-none @endif"
                                    href="{{ route('client.order.cancel', $od->id) }}">Hủy đơn hàng</a>
                                <a class="btn btn-primary text-light"
                                    href="{{ route('client.order.detail', $od->id) }}">Chi
                                    tiết đơn hàng</a>
